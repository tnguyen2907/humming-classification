...
df = pd.read_csv('fingerprint_hum_freq.csv')
used_songs = ['Frozen', 'Hakuna', 'Mamma', 'Panther', 'Potter', 'Rain', 'Showman', 'StarWars']
...
clf = RandomForestClassifier(max_leaf_nodes=100, random_state=12345).fit(X_train, y_train)
